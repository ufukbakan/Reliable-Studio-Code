...
const createWindow = () => {
  ...
  mainWindow.setMenu(Menu.buildFromTemplate([{
    ...
    submenu: [
      /*{
        label: "Say hello", click: () => {
          try {
            mainWindow.webContents.send("say-hello", "hello");
            console.log("say hello mesajı gönderildi");
          }
          catch (ex) {
            console.log(ex);
          }
      ...
      {
        label: "Open", click: () => {
          showCodeFilesDialog(mainWindow);
        }
      },
      {
        label: "Open Encoded File",
        click: ()=>{ showEncodedFilesDialog(mainWindow) }
      },
      {
        label: "Save",
        click: ()=>{}
